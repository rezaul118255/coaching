        ...
        <div>
            <footer className="footer p-10 bg-base-200 text-base-content">
                <nav>
                    ...
                    <a className="link link-hover">+8801875951964
                    </a>
                    <a className="link link-hover">rezaul118255@gmail.com</a>
                    <a className="link link-hover">Saadat College, Karatia, Tangail</a>
            ...
            <footer className="px-10 footer items-center p-4 bg-base-200 text-base-content">
                <aside className="items-center grid-flow-col">
                    ...
                    <p>Copyright © 2024 - All right reserved <br className="block sm:hidden" /><a className="text-blue-500 underline" href="https://rezaul.netlify.app/">Rezaul</a></p>
